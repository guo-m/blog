...
启动环境
在入门篇讲过，geth是一个以太坊客户端，现在利用 geth 启动一个以太坊（开发者）网络节点。
...
![1](https://learnblockchain.cn/images/geth_accounts_1.jpg)
...
```
回车后，返回的是0，新账户是0。结果如：
![2](https://learnblockchain.cn/images/geth_accounts_2.jpg)
...
999999999999793821
```
是不是比之前转账的余额少呀！如果余额不对，需要检查一下第六行的账户。
...
运行截图如下：
![4](https://learnblockchain.cn/images/init_example_show.jpg)
